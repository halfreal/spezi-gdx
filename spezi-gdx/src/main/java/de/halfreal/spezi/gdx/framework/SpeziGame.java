...
public abstract class SpeziGame extends Game {
    ...
    public SpeziScreen getScreen() {
        return (SpeziScreen) super.getScreen();
    }

    /**
     * Load a SpeziScreen from the defined Package and from the System
     * Property -Dscreen=<YourScreenName>
     *
     * @return the SpeziScreen or null if no class found or if no
